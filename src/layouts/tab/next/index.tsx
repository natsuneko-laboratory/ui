  ...
  return (
    ...
    >
      {items.map((item) => {
          ...
          return (
            ...
            <div
              ...
              className={classnames(
                "box-border py-3 flex items-center justify-center text-lg border-b-4 border-transparent -mb-0.5 cursor-pointer",
        ...
        return (
          <Link key={item.key} href={href} aria-disabled={item.disabled}>
            <div
              className={classnames(
                "box-border py-3 flex items-center justify-center text-lg border-b-4 border-transparent -mb-0.5",
                "hover:bg-neutral-100 dark:hover:bg-neutral-800 duration-300 transition-all",
                isActive && " border-sky-400 dark:border-sky-600"
              )}
            >
